...
hidden if the `mana-machine_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `mana-machine_DEVELOPER_MODE` to the configure
...
Runs the executable target `mana-machine_exe`.
